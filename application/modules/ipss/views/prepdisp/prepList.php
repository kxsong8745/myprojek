                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="datetime-local" class="form-control form-control-sm disp_date"
                                        id="disp_date_<?= $record->T05_PREP_ID ?>" data-prep-id="<?= $record->T05_PREP_ID ?>">
                                </td>
                                <td class="text-center">
                                    <!-- Action buttons -->
                                    <button class="btn btn-success btn-sm dispense-btn"
                                        data-prep-id="<?= $record->T05_PREP_ID ?>" data-units="<?= $record->T05_PREP_UNITS ?>">
...
<div class="modal fade" id="dispenseModal" tabindex="-1" role="dialog" aria-labelledby="dispenseModalLabel"
    aria-hidden="true">
