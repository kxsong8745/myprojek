        ...
        <form method="POST" action="<?php echo module_url('drug/updateDrug/' . $drug->T01_DRUG_ID) ?>">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control form-control-sm" id="drugs" 
                       placeholder="Drug Name" name="drugs" 
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control form-control-sm" id="tradeName" 
                       placeholder="Trade Name" name="tradeName" 
                       value="<?= $drug->T01_TRADE_NAME ?>" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control form-control-sm" id="minStock" 
                       placeholder="Minimum Stock" name="minStock" 
                       value="<?= $drug->T01_MIN_STOCK ?>" required>
            </div>
