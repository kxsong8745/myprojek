<div class="card mx-auto mt-4 shadow-sm" style="max-width: 600px;">
    ...
    <div class="card-body">
        ...
        <form action="<?= module_url('drug/updateBatch/' . $batch->T02_BATCH_ID) ?>" method="POST" class="needs-validation" novalidate>
            ...
            <div class="row mb-2">
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control form-control-sm" id="packageQty" name="packageQty" step="0.01" min="0" value="<?= $batch->T02_PACKAGE_QUANTITY ?>" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control form-control-sm" id="totalPricePackageQty" name="totalPricePackageQty" step="0.01" min="0" value="<?= $batch->T02_TP_PACKAGE_QUANTITY ?>" required>
            ...
            <div class="row mb-2">
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control form-control-sm" id="unitPerPackage" name="unitPerPackage" min="1" value="<?= $batch->T02_UNIT_PER_PACKAGE ?>" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control form-control-sm" id="totalUnits" name="totalUnits" min="1" value="<?= $batch->T02_TOTAL_UNITS ?>" required>
            ...
            <div class="mb-2">
                ...
                <input type="number" class="form-control form-control-sm" id="poNo" name="poNo" value="<?= $batch->T02_PO_NO ?>" required>
            ...
            <div class="mb-2">
                ...
                <input type="number" class="form-control form-control-sm" id="pricePerUnit" name="pricePerUnit"
                       placeholder="Total Price / Package Quantity / Units per Package" step="0.01" min="0.01" value="<?= $batch->T02_PRICE_PER_UNIT ?>" required>
            ...
            <div class="mb-2">
                ...
                <input type="number" class="form-control form-control-sm" id="barcodeNum" name="barcodeNum"value="<?= $batch->T02_BARCODE_NUM ?>" required>
            ...
            <div class="row mb-2">
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control form-control-sm" id="manufacturedDate" name="manufacturedDate" value="<?= date('Y-m-d', strtotime($batch->T02_MFD_DATE)) ?>" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control form-control-sm" id="expiryDate" name="expiryDate" value="<?= date('Y-m-d', strtotime($batch->T02_EXP_DATE)) ?>" required>
            ...
            <div class="text-center mt-3">
                ...
                <a href="<?= module_url('drug/viewBatches/' . $batch->T02_BATCH_ID) ?>" class="btn btn-secondary btn-sm">Cancel</a>
            </div>
        </form>
    </div>
</div>
