...
<div class="col-lg-12">
  <div class="card">
	<div class="px-4 py-3 border-bottom">
	  <h5 class="card-title fw-semibold mb-0">ADD NEW VEHICLE</h5>
	...
	<div class="card-body">
	  <div class="mb-4 row align-items-center"> 
		...
		<div class="col-sm-9">
		  <input type="text" class="form-control" id="exampleInputText6" placeholder="Kod Kenderaan" name="kod_kend">
		</div>
	  </div>
	  <div class="mb-4 row align-items-center"> 
		<label for="exampleInputText5" class="form-label fw-semibold col-sm-3 col-form-label text-end">Nama Kenderaan</label>
		<div class="col-sm-9">
		  <input type="text" class="form-control" id="exampleInputText6" placeholder="Nama Kenderaan" name ="nama_kend">
		</div>
	  </div>
	  <div class="mb-4 row align-items-center">
		...
		<div class="col-sm-9">
		  <div class="input-group">
			<input type="text" class="form-control" id="exampleInputText6" placeholder="No Plat" name="no_plat">
		  </div>
		</div>
	  </div>
	  <div class="mb-4 row align-items-center">
		...
		<div class="col-sm-9">
		  <div class="input-group">
			<input type="text" class="form-control" id="exampleInputText6" placeholder="Jenama Kenderaan" name="jenama">
		  </div>
		</div>
	  </div>
      ...
      <div class="mb-4 row align-items-center">
		...
		<div class="col-sm-9">
		  <div class="input-group">
			<input type="text" class="form-control" id="exampleInputText6" placeholder="Varian Kenderaan" name="varian">
		  </div>
		</div>
	  </div>
